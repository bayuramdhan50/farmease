...
export default function EditPanenForm({ panenId }: EditPanenFormProps) {
  ...
  if (loading) {
    return (
      <div className="card bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 transition-all duration-300">
        <div className="animate-pulse">
          ...
          <div className="h-28 bg-gray-200 dark:bg-gray-700 rounded w-full mb-6"></div>
  ...
  if (fetchError) {
    return (
      <div className="card bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 transition-all duration-300">
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 p-4 rounded-lg mb-6 flex items-start shadow-sm">
        ...
        <button 
          ...
          className="px-5 py-2.5 text-sm font-medium rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-sm hover:shadow transition-all duration-200 flex items-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
        >
    ...
    <div className="card bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 transition-all duration-300 hover:shadow-xl">
      <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-100 dark:border-gray-700">
        <div className="flex items-center">
          <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-blue-400 to-blue-600 dark:from-blue-500 dark:to-blue-700 flex items-center justify-center mr-3 shadow-md transform transition-transform hover:scale-105">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
            </svg>
          </div>
          <div>
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Edit Data Panen</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Ubah informasi panen yang sudah ada</p>
          </div>
        </div>
        <EncryptionIndicator />
      </div>
          ...
          <div className="form-group">
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="Luas lahan dalam meter persegi"
                step="0.01"
                min="0.01"
                required
              />
